...
def register_expense_handlers(app):
    conv_handler = ConversationHandler(
        entry_points=[
            #MessageHandler(filters.Regex("^\\+ Add Expense$"), add_expense_start) #error because When you click ➕ Add Expense it's not responding. This is because the button text in start.py has ➕ but in expense.py the filter looks for + Add Expense without the emoji.
